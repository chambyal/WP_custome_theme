        ...
        <div class="map-address-wrap" itemscope itemtype="https://schema.org/LegalService">
            <div class="d-none">
                ...
                <img src="<?php bloginfo('template_url'); ?>/img/logo.png" 
                     itemprop="image" alt="<?php echo bloginfo('name'); ?>"/>      
            </div>    
            ...
            <div class="footer-nap-row">
                ...
                <div class="footer-nap-col">
                        ...
                        <div class="address-wrap">
                            <div class="address">  
                                ...
                                if ($nap_attorney_business_name) {
                                    echo "<div itemprop='name' class='business-name'>" . $nap_attorney_business_name . "</div>";
                                }
                                ?>
                                ...
                                <?php
                                if ($nap_city_county) {
                                    echo '<span itemprop="addressLocality">' . $nap_city_county . '</span>,&nbsp;';
                                }
                                ?>
                                <?php
                                if ($nap_state) {
                    ...
                    <div class="d-none" itemscope itemtype="http://schema.org/Place">
                        <span itemprop='name' class='d-none cname'><?php bloginfo('name'); ?></span>
